...
def run_multiple_simulations(num_simulations=10, base_seed=2108, custom_seeds=None, enable_trade_log=False):
    ...
    for i in range(num_simulations):
        ...
        if custom_seeds is not None:
            # Use custom seeds, but use a different market seed for each simulation
            ...
            # Use default method to generate seeds
...
def main():
    ...
    # Centralized setting of all random seeds
    base_seed = 2108
    random_seeds = {
        'base_seed': base_seed,
    ...
    num_simulations = 20  # Reduced number of simulations to speed up execution
    ...
    print("Simulation completed. Results saved to 'average_market_simulation_results.png'")
